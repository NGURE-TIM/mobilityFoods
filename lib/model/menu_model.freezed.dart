...
abstract class $MenuCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String title, String restaurantChain, String image});
}
...
class _$MenuImpl implements _Menu {
  ...
  @override
  String toString() {
    return 'Menu(id: $id, title: $title, restaurantChain: $restaurantChain, image: $image)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, title, restaurantChain, image);
...
abstract class _Menu implements Menu {
  const factory _Menu(
      ...
      required final String image}) = _$MenuImpl;
